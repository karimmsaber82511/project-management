...
{
    [DbContext(typeof(CompanyEmployeeProjectDbContext))]
    [Migration("20260214022311_AddTaskEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyEmployeeProject.Companies.Company", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("CompanyEmployeeProject.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CompanyEmployeeProject.Projects.EmployeeProject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CompanyEmployeeProject.Projects.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CompanyEmployeeProject.Tasks.Task", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CompanyEmployeeProject.Employees.Employee", b =>
                {
                    b.HasOne("CompanyEmployeeProject.Companies.Company", "Company")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("CompanyEmployeeProject.Projects.EmployeeProject", b =>
                {
                    b.HasOne("CompanyEmployeeProject.Employees.Employee", "Employee")
                        .WithMany("EmployeeProjects")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CompanyEmployeeProject.Projects.Project", "Project")
                        .WithMany("EmployeeProjects")
            ...
            modelBuilder.Entity("CompanyEmployeeProject.Tasks.Task", b =>
                {
                    b.HasOne("CompanyEmployeeProject.Employees.Employee", "AssignedTo")
                        .WithMany()
