...
public static class CompanyEmployeeProjectEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE CompanyEmployeeProjectModuleExtensionConfigurator CLASS (in the Domain.Shared project)
