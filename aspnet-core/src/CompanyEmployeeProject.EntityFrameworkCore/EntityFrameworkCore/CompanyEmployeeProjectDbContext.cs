...
public class CompanyEmployeeProjectDbContext :
    AbpDbContext<CompanyEmployeeProjectDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new EntityFrameworkCore.Companies.CompanyConfiguration());
